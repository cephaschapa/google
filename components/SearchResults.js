...
function SearchResults({results}) {
    return (
        <div className="mx-auto w-full px-3 sm:pl-[5%] md:pl-[14%] lg:pl52">
                ...
                return(
                    <div key={result.link} className="max-w-xl mb-8">
                        <div className="group">
                            ...
                            <a href={result.link}>
                                <h2 className="truncate text-xl text-blue-500 font-medium group-hover:underline">{result.title}</h2>
                            </a>
                        </div>
